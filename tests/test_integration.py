...
def project(tmp_path):
    ...
    atomic_write_json(os.path.join(data_dir, "live", "polymarket_market.json"), {"market_id": "test-market", "asset_id": "token123"})
...
def test_full_round_lifecycle(project):
    ...
    runner.record_prediction(agent1, 1710000000, "Up", 0.7, "OB imbalance bullish", "v1")
    runner.record_prediction(agent2, 1710000000, "Down", 0.6, "Momentum bearish", "v1")
